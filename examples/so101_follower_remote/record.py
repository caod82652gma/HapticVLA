...
def main():
    ...
    robot_config = SO101FollowerClientConfig(remote_ip="192.168.1.101", id="my_so101_follower")
    leader_arm_config = SO101LeaderConfig(port="/dev/tty.usbmodem585A0077581", id="my_awesome_leader_arm")
    ...
    init_rerun(session_name="so101_follower_record")
